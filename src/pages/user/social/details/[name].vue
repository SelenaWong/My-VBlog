        ...
        <div v-loading="loading">
            <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;">
                <div slot="header" class="clearfix">
                    ...
                    <ClientOnly>
                        <el-button @click="$router.go(-1)" style="float: right; padding: 3px 0" type="text"
                                   >返回
                        </el-button>
                    </ClientOnly>
                </div>
                <el-row>
                    <el-col :span="9" style="padding: 0px 10px 20px 0px">
                        ...
                        <div style="padding: 10px">
                            ...
                            <font style="font-size: 14px;line-height: 20px;color:#606266;" v-show="location">
                                <i class="el-icon-location-outline"></i>&nbsp;&nbsp;{{location}}
                                <br>
                            </font>
                            <font style="font-size: 14px;line-height: 20px;color:#606266;" v-show="email">
                                <i class="el-icon-message"></i>&nbsp;&nbsp;{{email}}
                                <br>
                            </font>
                            <font style="font-size: 14px;color:#606266;" v-show="blog">
                                <i class="el-icon-edit-outline"></i>&nbsp;&nbsp;
                                <g-link :to="$util.addHttp(blog)" target="_blank">{{blog}}</g-link>
                                <br>
                            </font>
                        </div>
