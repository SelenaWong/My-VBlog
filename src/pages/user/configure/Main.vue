                    ...
                    <el-tabs v-model="activeTab" type="card">
                        <el-tab-pane label="基础配置" name="base" style="padding: 5px">
                            ...
                            <el-form-item label="博客标题" prop="blogTitle">
                                <el-input v-model="configure.blogTitle"
                                          :placeholder="configure.githubUsername"></el-input>
                            </el-form-item>
                            <el-form-item label="博客描述" prop="blogDescribe">
                                <el-input v-model="configure.blogDescribe"
                                          :placeholder="'欢迎来到'+configure.githubUsername+'的个人博客。'"></el-input>
                            </el-form-item>
                            <el-form-item label="页面标题" prop="htmlTitle">
                                <el-input v-model="configure.htmlTitle"
                                          :placeholder="configure.githubUsername+'的博客'"></el-input>
                            </el-form-item>
                                    ...
                                    <el-col :span="3">
                                        <el-form-item label="背景颜色">
                                            <el-color-picker :predefine="predefineColors"
                                                             v-model="configure.backgroundColorLeft"></el-color-picker>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="21">
                                        <el-form-item>
                                            <el-color-picker :predefine="predefineColors"
                                                             v-model="configure.backgroundColorRight"></el-color-picker>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                        ...
                        <el-tab-pane label="扩展配置" name="extend" style="padding: 5px">
                            <el-form-item label="其他网站">
                                <el-row v-for="(item,index) in configure.webSites" :key="'webSites'+index"
                                        style="margin-bottom: 10px">
                                    <el-col :span="8" style="padding-right: 10px">
                                        <el-input v-model="configure.webSites[index].name"
                                                  placeholder="网站名字 例如: V2EX"></el-input>
                                    </el-col>
                                    <el-col :span="14" style="padding-right: 10px">
                                        <el-input v-model="item.url" placeholder="完整URL 例如: https://..."></el-input>
                                    </el-col>
                                    <el-col :span="2">
                                        <el-button @click="removeWebSites(index)" style="float: right;"
                                                   icon="el-icon-delete" type="danger" circle></el-button>
                                    </el-col>
                                </el-row>
                                <el-button @click="addWebSites" style="float: right;" icon="el-icon-plus" type="success"
                                           circle></el-button>
                            </el-form-item>
                        </el-tab-pane>
                    </el-tabs>
                    <el-form-item>
                        <el-button @click="submit" :loading="submitButton.loading" :disabled="submitButton.disabled"
                                   type="primary">修改配置
                        </el-button>
                        ...
                        <el-popover placement="top-end" width="200" trigger="click"
                            ...
                            <el-button slot="reference" icon="el-icon-question" type="text" style="float: right;">说明
                            </el-button>
                        </el-popover>
                    </el-form-item>
                </el-form>
