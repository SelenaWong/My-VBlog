            ...
            <el-card shadow="never" style="min-height: 600px;margin-bottom: 20px;">
                <el-collapse v-model="active" accordion>
                    <el-collapse-item title="如何部署" name="deploy">
                        ...
                        <el-steps :active="deploy.active" align-center style="margin-top: 20px;"
                                  :process-status="deploy.status">
                            <el-step title="克隆项目"
                                     description="https://github.com/GitHub-Laziji/GitHub-Laziji.github.io"></el-step>
                            <el-step title="修改配置"
                                     description="将 /static/configuration.json 中的 githubUsername  改为自己的"></el-step>
                    ...
                    <el-collapse-item title="如何使用" name="use">
                        ...
                        <el-steps :active="use.active" align-center style="margin-top: 20px;"
